  ...
  return (
    <>
      <Layout>
        ...
        <Container>
          <Header />
          <svg className="circles" width="100%" height="100%" viewBox="0 0 500 500">
            <def>
            ...
            <text className="circles__text circles__text--5">
            ...
            <text className="circles__text circles__text--6">
              <textPath className="circles__text-path" xlinkHref="#circle-6" aria-label="" >It was going to be a hell of a day. He knew it. He looked at his cell phone screen. It was dark. No texts messages that morning. No texts for the rest of the day, either. No messages.</textPath>
            </text>
